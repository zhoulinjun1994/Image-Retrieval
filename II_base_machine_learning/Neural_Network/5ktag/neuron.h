...
const int layers = 4, maxn = 5427+10, maxm = 10000000, maxt = 100000;
const int neu_num[layers] = {maxn + 1, 300 + 1, 60 + 1, 2};
const int inner = 0, outer = 0;
const double erange = 0.1, eps = 1e-8;
const double error_max = maxm * 0.01, ident = 0.95, learning_rate = 0.8, alfa = 0.4;
...
struct neuron
{
	...
	double w[5427+10+1], old[5427+10+1];
	double y, u, delta;
